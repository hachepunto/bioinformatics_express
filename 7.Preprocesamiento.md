...
Ver presentación [**FastQ**](./FastQ.pdf)
...
Para este ejercicio vamos a utlilizar datos de la liga de arriba que ya están descargados.

```
cd ~/datos.taller/
idx="~/datos.taller/refs/chr22.idx"
reads="~/datos.taller/data/HBR_Rep1_ERCC-Mix2_Build37-ErccTranscripts-chr22.read1.fastq.gz"
mates="~/datos.taller/data/HBR_Rep1_ERCC-Mix2_Build37-ErccTranscripts-chr22.read2.fastq.gz"
...
```
idx="/home/datos.taller/refs/chr22.idx"

for id in HBR_Rep1 HBR_Rep2 HBR_Rep3
do
  reads="/home/datos.taller/data/${id}_ERCC-Mix2_Build37-ErccTranscripts-chr22.read1.fastq.gz"
  mates="/home/datos.taller/data/${id}_ERCC-Mix2_Build37-ErccTranscripts-chr22.read2.fastq.gz"
